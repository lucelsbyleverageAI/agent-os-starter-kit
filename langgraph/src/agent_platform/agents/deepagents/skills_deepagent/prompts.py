...
- Sub-agents respond in chat by default, with detail proportional to the task
- For a file output, include a path in your task (e.g., "...create file at /sandbox/workspace/analysis.md")
