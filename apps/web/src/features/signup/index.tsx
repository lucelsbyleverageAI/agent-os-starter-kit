// DISABLED: Signup is currently disabled in favor of invitation-only registration
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription className="text-center">
                                Sign up to get started with AgentOS
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
...
// Temporary disabled signup component
export default function SignupInterface() {
  return (
    <div className="flex min-h-screen items-center justify-center py-10">
      <div className="w-full max-w-md text-center">
        <h1 className="text-2xl font-bold mb-4">Registration by Invitation Only</h1>
        <p className="text-muted-foreground mb-6">
          New accounts can only be created through email invitations. 
