    ...
    try {
      ...
      if (error) {
        ...
        if (errorMessage.includes("Error sending recovery email")) {
          errorMessage = "We're experiencing technical difficulties sending emails. Please try again in a few minutes or contact support.";
        } else if (errorMessage.includes("Email not confirmed")) {
          errorMessage = "Please check your email and confirm your account before requesting a password reset.";
